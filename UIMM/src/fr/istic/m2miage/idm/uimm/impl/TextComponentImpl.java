 ...
 * <ul>
 *   <li>{@link fr.istic.m2miage.idm.uimm.impl.TextComponentImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextComponentImpl extends ComponentImpl implements TextComponent {
	...
	protected EClass eStaticClass() {
		return UimmPackage.Literals.TEXT_COMPONENT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimmPackage.TEXT_COMPONENT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimmPackage.TEXT_COMPONENT__TEXT:
				return getText();
		}
