...
public class UimmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UimmPackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UimmPackage.IMAGE_COMPONENT: {
				ImageComponent imageComponent = (ImageComponent)theEObject;
				T result = caseImageComponent(imageComponent);
				if (result == null) result = caseTextComponent(imageComponent);
				if (result == null) result = caseComponent(imageComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UimmPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UimmPackage.TEXT_COMPONENT: {
			...
			case UimmPackage.LIST_COMPONENT: {
				ListComponent listComponent = (ListComponent)theEObject;
				T result = caseListComponent(listComponent);
				if (result == null) result = caseTextComponent(listComponent);
				if (result == null) result = caseComponent(listComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseImageComponent(ImageComponent object) {
		return null;
	}
