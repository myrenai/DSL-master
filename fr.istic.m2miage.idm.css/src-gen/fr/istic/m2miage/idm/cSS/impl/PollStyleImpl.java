...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Poll Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.PollStyleImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.PollStyleImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.PollStyleImpl#getBorderType <em>Border Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PollStyleImpl extends MinimalEObjectImpl.Container implements PollStyle
{
  /**
  ...
  {
    return CSSPackage.Literals.POLL_STYLE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.POLL_STYLE__NAME, oldName, name));
  }
  ...
  public void setColor(ColorEnum newColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.POLL_STYLE__COLOR, oldColor, color));
  }
  ...
  public void setBorderType(BorderTypeEnum newBorderType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.POLL_STYLE__BORDER_TYPE, oldBorderType, borderType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CSSPackage.POLL_STYLE__NAME:
        return getName();
      case CSSPackage.POLL_STYLE__COLOR:
        return getColor();
      case CSSPackage.POLL_STYLE__BORDER_TYPE:
