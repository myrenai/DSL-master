...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Single Question Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.SingleQuestionStyleImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.SingleQuestionStyleImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fr.istic.m2miage.idm.cSS.impl.SingleQuestionStyleImpl#getBorderType <em>Border Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SingleQuestionStyleImpl extends MinimalEObjectImpl.Container implements SingleQuestionStyle
{
  /**
   ...
   * @generated
   */
  protected SingleQuestionStyleImpl()
  {
    super();
  }
  ...
  {
    return CSSPackage.Literals.SINGLE_QUESTION_STYLE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.SINGLE_QUESTION_STYLE__NAME, oldName, name));
  }
  ...
  public void setColor(ColorEnum newColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.SINGLE_QUESTION_STYLE__COLOR, oldColor, color));
  }
  ...
  public void setBorderType(BorderTypeEnum newBorderType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CSSPackage.SINGLE_QUESTION_STYLE__BORDER_TYPE, oldBorderType, borderType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CSSPackage.SINGLE_QUESTION_STYLE__NAME:
        return getName();
      case CSSPackage.SINGLE_QUESTION_STYLE__COLOR:
        return getColor();
      case CSSPackage.SINGLE_QUESTION_STYLE__BORDER_TYPE:
