...
public class CSSStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new fr.istic.m2miage.idm.CSSRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.istic.fr/m2miage/idm/CSS")) {
		EPackage.Registry.INSTANCE.put("http://www.istic.fr/m2miage/idm/CSS", fr.istic.m2miage.idm.cSS.CSSPackage.eINSTANCE);
	}
